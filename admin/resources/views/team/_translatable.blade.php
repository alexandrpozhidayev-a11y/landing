...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
    <div>
        <x-input-label for="first_name_{{ $code }}" :value="__('First name')" />
    ...
    <div>
        <x-input-label for="last_name_{{ $code }}" :value="__('Last name')" />
    ...
    <div>
        <x-input-label for="middle_name_{{ $code }}" :value="__('Middle name (optional)')" />
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
    <div>
        <x-input-label for="department_{{ $code }}" :value="__('Department (label above the name, e.g. Project leadership)')" />
    ...
    <div>
        <x-input-label for="role_{{ $code }}" :value="__('Position')" />
...
<div>
    <x-input-label for="bio_{{ $code }}" :value="__('Short bio')" />
