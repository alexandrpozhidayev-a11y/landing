...
<div>
    <x-input-label for="title_{{ $code }}" :value="__('Title')" />
...
<div>
    <x-input-label for="excerpt_{{ $code }}" :value="__('Short text (shown in news lists)')" />
...
<div>
    <x-input-label for="body_{{ $code }}" :value="__('Full text')" />
